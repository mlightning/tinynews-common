...
var Tinynews       = require('../../database.js');
...
var commands = [
    ...
    // Admin Profile
    'INSERT INTO UserProfile SET street1="", street2="", city="Vancouver", state="British Columbia", country="Canada", zip="", website_url="http://tinynews.com", phone_home="", phone_mobile="", about_me="I\'m  the tinynews.com site administrator.", modification_date="1407504288", creation_date="1407504288"',
    ...
    // Admin Background
    'INSERT INTO UserBackground SET title="Product Manager", description="Product management for Tinynews.com", organization="Tinynews.com", year_start="2013", year_end="2014", creation_date="1407504288", modification_date="1407504288"',
...
Tinynews.connect(Config, function(e) {
    if (e) {
        Util.log(e);
