...
var TestData = {
    TestUser: {
        ...
        first_name: 'Test',
        last_name: 'User',
        email: 'marius+tnews_test@gmail.com',
        imageUrl: 'http://files1.nolet.com:3000/files/sites/nolet/user/2014/8/12/7df4048c075d590207b39ba9a1f8c801/Windows-7-RTM-Default-Wallpaper-the-Design-Story-2.jpg',
        status: 1,
        userProfile: {
    ...
    TestGroup: {
        name: 'administrators',
        url: 'http://nolet.com/group/admins',
        status: 1,
...
describe('Users :', function() {
    ...
    before(function(done) {
        Nolet.connect(Config, function(e) {
            if (e) {
                Util.log(e);
                Util.log("No OrientDB, test shutting down...");
            }

            Nolet.odb.vertex.create({
                '@class': 'User',
                handle: 'munish',
