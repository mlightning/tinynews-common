...
User.prototype.fetch_profile = function(cb) {
    ...
    Tinynews.odb
        ...
        .all()
        .then(function(udata) {
            udata[0]['@rid'] = Tinynews.RID.Build(udata[0]['@rid']);

            if (typeof udata[0].out_UserHasProfile != 'undefined') {
                udata[0].out_UserHasProfile = Tinynews.RID.Build(udata[0].out_UserHasProfile);
            }
            if (typeof udata[0].in_UserHasFeedSettings != 'undefined') {
                udata[0].in_UserHasFeedSettings = Tinynews.RID.Build(udata[0].in_UserHasFeedSettings);
            }
            if (typeof udata[0].in_UserFriendUser != 'undefined') {
                udata[0].in_UserFriendUser = Tinynews.RID.Build(udata[0].in_UserFriendUser);
            }
            if (typeof udata[0].in_UserFollow != 'undefined') {
                udata[0].in_UserFollow = Tinynews.RID.Build(udata[0].in_UserFollow);
            }
            if (typeof udata[0].out_UserFollow != 'undefined') {
                udata[0].out_UserFollow = Tinynews.RID.Build(udata[0].out_UserFollow);
            }
            if (typeof udata[0].in_UserFeedSettingsHasFriend != 'undefined') {
                udata[0].in_UserFeedSettingsHasFriend = Tinynews.RID.Build(udata[0].in_UserFeedSettingsHasFriend);
            }
...
User.prototype.get_groups = function(cb) {
    Tinynews.odb
        ...
        .then(function(data) {
            ...
            for (var i in data) {
                data[i]['@rid'] = Tinynews.RID.Build(data[i]['@rid']);
...
User.prototype.get_comments = function(cb) {
    Tinynews.odb
        ...
        .then(function(data) {
            ...
            for (var i in data) {
                data[i]['@rid'] = Tinynews.RID.Build(data[i]);
