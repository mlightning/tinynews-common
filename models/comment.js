        ...
        .then(function(data) {
            if (data && data.length) {
                ...
                if (data[0]['in_UserHasComment']) {
                    data[0]['in_UserHasComment'] = Tinynews.RID.Build(data[0]['in_UserHasComment']);
                }
                if (data[0]['in_PublisherHasComment']) {
                    data[0]['in_PublisherHasComment'] = Tinynews.RID.Build(data[0]['in_PublisherHasComment']);
                }
                if (data[0]['in_JournalistHasComment']) {
                    data[0]['in_JournalistHasComment'] = Tinynews.RID.Build(data[0]['in_JournalistHasComment']);
                }
                if (data[0]['in_ArticleHasComment']) {
                    data[0]['in_ArticleHasComment'] = Tinynews.RID.Build(data[0]['in_ArticleHasComment']);
                }
