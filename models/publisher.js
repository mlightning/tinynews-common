    ...
    Tinynews.odb
        ...
        .then(function(data) {
            if (data && data.length) {
                ...
                for (var i in data) {
                    data[i]['@rid'] = Tinynews.RID.Build( data[i]['@rid'] );
                    data[i].in_UserHasComment = Tinynews.RID.Build( data[i].in_UserHasComment );
                    data[i].in_PublisherHasComment = Tinynews.RID.Build( data[i].in_PublisherHasComment );

                    var new_comment = new Comment(data[i]);

                    if (typeof data[i].in_CommentHasChildComments != 'undefined') {
                        data[i].in_CommentHasChildComments = Tinynews.RID.Build( data[i].in_CommentHasChildComments );
                        ...
                        if (data && data.length) {
                            ...
                            for (var i in data) {
                                for (var j in data[i].in) {
                                    data[i].in[j] = Tinynews.RID.Build(data[i].in[j]);
